...
function youtube(link){
	return new Promise(async (resolve, reject) => {
		const getDataFirst = await axios.get('https://www.y2mate.com/mates/en68/analyze/ajax')
		...
		let headerss = 	{
			...
			"Cookie": `${newCookie} _ga=GA1.2.405896420.1625200423; _gid=GA1.2.2135261581.1625200423; _PN_SBSCRBR_FALLBACK_DENIED=1625200785624; MarketGidStorage={"0":{},"C702514":{"page":5,"time":1625200846733}}`
		}
